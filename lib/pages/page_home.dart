...
import 'package:Mumbai_Dabbawala/models/category.dart';
import 'package:Mumbai_Dabbawala/models/item.dart';
import 'package:Mumbai_Dabbawala/models/product.dart';
import 'package:Mumbai_Dabbawala/screens/store_detail_page.dart';
...
class _PageHomeState extends State<PageHome>
  ...
  Future<void> loadData() async {
    ...
    var message = await http
        .get("http://jugaadapp.microhind.com/apib/api.php?get_hmessage");
    msg = message.body;

    var res = await http
        .get("http://jugaadapp.microhind.com/apib/api.php?get_category");
    categorys = categoryFromJson(res.body);

    var resp = await http
        .get("http://jugaadapp.microhind.com/apib/api.php?category_home");
    best = productFromJson(resp.body);
  ...
  //   count = await databaseHelper.getCount();
  //   setState(() {});
  // }
